...
export class Backend implements backendInterface {
    ...
    async searchDestination(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.searchDestination(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string): Promise<void> {
        if (this.processError) {
            try {
